  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-14">
      ...
      <div className="mt-8 space-y-7 text-sm leading-7 text-[#4B5563]">
        <section><h2 className="font-display text-xl font-semibold text-[#111827]">Information we collect</h2><p className="mt-2">When you sign in, we store your account identifier, email address, verification status, display name, optional profile image, and active sessions. We store polls you create, votes, reports, basic security logs, and rate-limit records. Anonymous voters receive a random signed cookie so the same browser cannot vote repeatedly in one poll.</p></section>
